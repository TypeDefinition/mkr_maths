...
namespace mkr {
    const line line::x_axis{vector3::zero, vector3::x_direction};
    const line line::y_axis{vector3::zero, vector3::y_direction};
    const line line::z_axis{vector3::zero, vector3::z_direction};
